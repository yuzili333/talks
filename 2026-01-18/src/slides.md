...
今天我们的主题是一个叫做飞行的小鸟的游戏，大家可以叫他做fly bird，他最喜欢的活动就是躲避障碍物。
...
<div class="grid grid-cols-[3fr_4fr] gap-4 h-full">
  ...
  <div ma flex="~ col gap-2 items-center">
    ...
    <div text-orange text-sm bg-orange:10 px2 rounded>Flappy Bird</div>
  </div>
...
**老师**：“小朋友们好！今天我们要做一个关于飞行的小鸟游戏的动画效果。小鸟最喜欢自由的飞行，我们要帮他设计一个有趣的游戏故事！”

**互动**：来我们玩一个关于飞行的小鸟的游戏，请各位小朋友关注该游戏中有哪些角色、动作以及场景。
...
<div flex="~ items-center" w-140 p-8><img src="/flappy-bird.avif" w-120 /></div>
...
- 小鸟一直在重复什么动作
- 飞行过程会遇到哪些障碍物
- 需要完成做什么操作才能顺利帮助小鸟顺利飞过所有障碍物

#### 介绍本节课要完成的动作

- 1、绘制一个小朋友喜欢的背景（如蓝天白云、树枝、烟囱等），并添加一个小鸟的角色。
- 2、添加多个障碍物角色，分别放置在不同的位置。
- 3、为小鸟角色编写程序，使其能够通过点击屏幕上的按钮来向上飞行躲避障碍物。
- 4、为每个障碍物角色编写程序，障碍物会向前移动并不停摆动，固定时间间隔会出现第二组障碍物；当小鸟碰到障碍物时，障碍物会消失并播放一个碰撞的声音。
- 5、当所有障碍物都被飞过之后，显示成功结算画面（小鸟开心的跳起来舞动）；如果游戏中小鸟被障碍物碰到，则显示失败画面（小鸟伤心地坐下哭泣）。
- 6、录制一段飞行时的声音效果，录制一段碰撞的声音效果

**难点** 如何实现障碍物自动向前移动，循环移动，重复动作设计、以及小鸟自动下落以及控制向上飞行等。要求障碍物不低于两组，游戏成功时长不低于30秒

**加分项**

- 评选最美设计背景、小鸟绘制
- 录制小鸟碰到障碍物的声音的音效、开心的音效、哭泣的音效等
